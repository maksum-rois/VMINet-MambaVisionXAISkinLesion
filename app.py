...
st.caption("Integrasi MambaVision/VMINet, DullRazor+CLAHE, dan Visual XAI (Grad-CAM++, Score-CAM)")

# ==========================================
# 2. PEMUATAN CLASS MAPPING (JSON / FALLBACK)
# ==========================================
@st.cache_data
...
# ==========================================
# 3. FUNGSI PREPROCESSING & XAI UTILS
# ==========================================
...
with tab1:
    ...
    with col1:
        ...
        * **Jumlah Kelas Terdaftar**: **{}** Kelas Diagnostik.
...
with tab5:
    ...
    with col_up:
        inf_f = st.file_uploader("Unggah Citra Dermoskopi:", type=["jpg", "png", "jpeg"], key="l_up")
